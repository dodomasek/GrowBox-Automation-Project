...
13. Assemble all the stuff in growbox. Connect PSUs. Check connections triple times, as dangerous high voltage presents on controller board and relays controls it.
